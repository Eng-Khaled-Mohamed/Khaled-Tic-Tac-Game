...
function whowin(board,notvirt=1){
    ...
    if (arrxo[0]==0&&arrxo[1]==0&&arrxo[2]==0){
        if (notvirt){
        td[0].style='background:rgb(49, 248, 9);'
        td[1].style='background:rgb(49, 248, 9);'
        td[2].style='background:rgb(49, 248, 9);'
        }
        return 0;
    }
    ...
    return 1;
        ...
        if (notvirt){
        td[3].style='background:rgb(49, 248, 9);'
        td[4].style='background:rgb(49, 248, 9);'
        td[5].style='background:rgb(49, 248, 9);'
        }
    return 0;
    }
    ...
    return 1;
        ...
        if (notvirt){
        td[6].style='background:rgb(49, 248, 9);'
        td[7].style='background:rgb(49, 248, 9);'
        td[8].style='background:rgb(49, 248, 9);'
        }
    return 0
    }
